  ...
  const createBuffer = useCallback(async () => {
    ...
    if (bufferType === 'radius') {
      const bufferGeometry = geometryEngine.buffer(
        ...
        bufferUnit === 'miles' ? Number(bufferValue) * 1609.34 : Number(bufferValue) * 1000,
        'meters'
      ) as __esri.Polygon;
          ...
          <TabsContent value="2">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label>Unit</Label>
                  <Select value={bufferUnit} onValueChange={(value: 'miles' | 'kilometers' | 'minutes') => setBufferUnit(value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
