...
export const DISABLED_ANALYSIS_CATEGORIES = {
  ...
  'Scenario Analysis': [
    'What if Nike changes its pricing strategy - which markets would be most resilient?'
  ],
  'Trend Analysis': [
    'Show me markets with the strongest growth trends for Nike'
  ],
  'Anomaly Detection': [
    'Show me statistical outliers in Nike market performance'
  ],
  'Feature Interactions': [
    'Which markets have the strongest interactions between demographics and Nike performance?'
  ],
  'Predictive Modeling': [
...
export const TRENDS_CATEGORIES = {
  ...
  'Scenario Planning & Adaptability': [
    'Which markets are most adaptable to different strategic scenarios?',
    'What if Nike changes its pricing strategy - which markets would be most resilient?',
    'Show me markets with the highest flexibility for strategic pivots',
    'Which markets can best handle economic downturns for Nike?',
    'Where should Nike invest for maximum scenario flexibility?',
    'Which markets have proven resilience across multiple business cycles?',
    'Show me markets that perform well under various what-if scenarios',
    'Which areas offer the best strategic pivot opportunities for Nike?'
  ],
  'Trends & Growth Analysis': [
    'Show me markets with the strongest growth trends for Nike',
    'Which areas have consistent upward momentum for athletic brands?',
    'Where is Nike experiencing the fastest market share growth?',
    'Which markets show accelerating demand for athletic footwear?',
    'Identify emerging markets with high growth potential for Nike',
    'Show me markets with stable, predictable growth patterns'
  ],
  'Data Quality & Anomalies': [
    'Which markets show unusual patterns that warrant investigation?',
    'Show me statistical outliers in Nike market performance',
    'Where are there data anomalies in market metrics?',
    'Identify markets with exceptional characteristics needing validation',
    'Which areas have performance metrics that deviate from regional norms?',
    'Show me markets with suspicious or inconsistent data patterns'
  ],
  'Advanced Analytics': [
    'Which markets have the strongest interactions between demographics and Nike performance?',
    'Show me where multiple factors synergistically drive Nike success',
    'Which markets are most likely to grow for Nike in the next year?',
