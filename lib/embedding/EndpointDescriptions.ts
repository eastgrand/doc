...
export const ENDPOINT_DESCRIPTIONS: Record<string, EndpointDescription> = {
  '/strategic-analysis': {
    ...
    sampleQueries: [
      ...
      'Identify the most promising markets for tax service growth'
    ],
    ...
    keywords: ['strategic', 'expansion', 'investment', 'opportunity', 'business planning', 'growth markets'],
    semanticConcepts: ['strategic planning', 'market expansion', 'business opportunities', 'investment decisions', 'growth strategy']
  },
  ...
  '/competitive-analysis': {
    ...
    sampleQueries: [
      ...
      'What is the competitive landscape for tax preparation services?',
      'How does H&R Block market share compare to competitors?',
      'Analyze competitive positioning in the tax service market',
      'Market share analysis between major tax software brands'
    ],
  ...
  '/correlation-analysis': {
    ...
    sampleQueries: [
      ...
      'Correlation analysis between income and tax service preference',
