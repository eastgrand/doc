  ...
  private loadEndpointConfigurations(): void {
    ...
    const configs: EndpointConfiguration[] = [
      ...
      },
      {
        ...
        responseProcessor: 'SpatialClustersProcessor',
      ...
      // Add remaining 13 endpoints with similar enhanced configurations...
      {
        ...
        targetVariable: 'correlation_analysis_score',
      ...
      },
      {
        ...
        targetVariable: 'trend_analysis_score',
      ...
      },
      {
        ...
        targetVariable: 'anomaly_detection_score',
      ...
      },
      {
        ...
        scoreFieldName: 'comparative_analysis_score',
      ...
      },
      {
        ...
        name: 'Ensemble Model Analysis',
        description: 'Analyze combined predictions from multiple machine learning models',
        category: 'advanced',
        url: '/ensemble-analysis',
        defaultVisualization: 'choropleth',
        payloadTemplate: { target_variable: '', sample_size: 5000, ensemble_method: 'voting' },
        responseProcessor: 'EnsembleAnalysisProcessor',
        keywords: ['ensemble', 'combined models', 'model ensemble', 'voting', 'bagging', 'boosting'],
        targetVariable: 'ensemble_analysis_score',
        scoreFieldName: 'ensemble_analysis_score',
        requiredFields: ['target_variable'],
        optionalFields: ['sample_size', 'ensemble_method'],
        expectedResponseTime: 30000,
        cacheable: true,
        rateLimit: { requests: 25, window: 3600000 },
        validationRules: { ensembleMethods: ['voting', 'bagging', 'boosting'] },
        mockResponses: false
      },
      {
        id: '/feature-importance-ranking',
        name: 'Feature Importance Analysis',
        description: 'Rank and analyze the importance of different variables in predictions',
        category: 'advanced',
        url: '/feature-importance-ranking',
        defaultVisualization: 'bivariate',
        payloadTemplate: { target_variable: '', sample_size: 5000, importance_method: 'permutation' },
        responseProcessor: 'FeatureImportanceRankingProcessor',
        keywords: ['feature importance', 'variable importance', 'ranking', 'significance', 'factor analysis'],
        targetVariable: 'feature_importance_ranking_score',
        scoreFieldName: 'feature_importance_ranking_score',
        requiredFields: ['target_variable'],
        optionalFields: ['sample_size', 'importance_method'],
        expectedResponseTime: 20000,
        cacheable: true,
        rateLimit: { requests: 40, window: 3600000 },
        validationRules: { importanceMethods: ['permutation', 'shap', 'gain'] },
        mockResponses: false
      },
      {
        id: '/dimensionality-insights',
        name: 'Dimensionality Analysis',
        description: 'Analyze data complexity and dimensional relationships in geographic datasets',
        category: 'advanced',
        url: '/dimensionality-insights',
        defaultVisualization: 'bivariate',
        payloadTemplate: { target_variable: '', sample_size: 5000, reduction_method: 'pca' },
        responseProcessor: 'DimensionalityInsightsProcessor',
        keywords: ['dimensionality', 'pca', 'dimensional reduction', 'complexity', 'data structure'],
        targetVariable: 'dimensionality_insights_score',
        scoreFieldName: 'dimensionality_insights_score',
        requiredFields: ['target_variable'],
        optionalFields: ['sample_size', 'reduction_method'],
        expectedResponseTime: 22000,
        cacheable: true,
        rateLimit: { requests: 35, window: 3600000 },
        validationRules: { reductionMethods: ['pca', 'tsne', 'umap'] },
        mockResponses: false
      },
      {
        id: '/consensus-analysis',
        name: 'Consensus Analysis',
        description: 'Analyze agreement and consensus across multiple models and predictions',
        category: 'advanced',
        url: '/consensus-analysis',
        defaultVisualization: 'choropleth',
        payloadTemplate: { target_variable: '', sample_size: 5000, consensus_threshold: 0.7 },
        responseProcessor: 'ConsensusAnalysisProcessor',
        keywords: ['consensus', 'agreement', 'model consensus', 'prediction agreement', 'ensemble consensus'],
        targetVariable: 'consensus_analysis_score',
        scoreFieldName: 'consensus_analysis_score',
        requiredFields: ['target_variable'],
        optionalFields: ['sample_size', 'consensus_threshold'],
        expectedResponseTime: 25000,
        cacheable: true,
        rateLimit: { requests: 30, window: 3600000 },
        validationRules: { maxThreshold: 1.0, minThreshold: 0.5 },
        mockResponses: false
      },
      {
        id: '/algorithm-comparison',
        name: 'Algorithm Comparison',
        description: 'Compare performance of different machine learning algorithms',
        category: 'advanced',
        url: '/algorithm-comparison',
        defaultVisualization: 'bivariate',
        payloadTemplate: { target_variable: '', sample_size: 5000, algorithms: [] },
        responseProcessor: 'AlgorithmComparisonProcessor',
        keywords: ['algorithm comparison', 'compare algorithms', 'model comparison', 'performance comparison'],
        targetVariable: 'algorithm_comparison_score',
        scoreFieldName: 'algorithm_comparison_score',
        requiredFields: ['target_variable'],
        optionalFields: ['sample_size', 'algorithms'],
        expectedResponseTime: 28000,
        cacheable: true,
        rateLimit: { requests: 25, window: 3600000 },
        validationRules: { maxAlgorithms: 8 },
        mockResponses: false
      },
      {
        id: '/sensitivity-analysis',
        name: 'Sensitivity Analysis',
        description: 'Analyze how sensitive model predictions are to input parameter changes',
        category: 'advanced',
        url: '/sensitivity-analysis',
        defaultVisualization: 'choropleth',
        payloadTemplate: { target_variable: '', sample_size: 5000, sensitivity_parameters: [] },
        responseProcessor: 'SensitivityAnalysisProcessor',
        keywords: ['sensitivity', 'parameter sensitivity', 'model sensitivity', 'robustness', 'stability'],
        targetVariable: 'sensitivity_analysis_score',
        scoreFieldName: 'sensitivity_analysis_score',
        requiredFields: ['target_variable'],
        optionalFields: ['sample_size', 'sensitivity_parameters'],
        expectedResponseTime: 25000,
        cacheable: true,
        rateLimit: { requests: 30, window: 3600000 },
        validationRules: { maxParameters: 10 },
        mockResponses: false
      },
      {
        id: '/model-performance',
        name: 'Model Performance Analysis',
        description: 'Comprehensive analysis of machine learning model performance and metrics',
        category: 'advanced',
        url: '/model-performance',
        defaultVisualization: 'choropleth',
        payloadTemplate: { target_variable: '', sample_size: 5000, performance_metrics: ['accuracy', 'precision'] },
        responseProcessor: 'ModelPerformanceProcessor',
        keywords: ['model performance', 'performance metrics', 'model evaluation', 'accuracy', 'precision', 'recall'],
        targetVariable: 'model_performance_score',
        scoreFieldName: 'model_performance_score',
        requiredFields: ['target_variable'],
        optionalFields: ['sample_size', 'performance_metrics'],
        expectedResponseTime: 22000,
        cacheable: true,
        rateLimit: { requests: 35, window: 3600000 },
        validationRules: { maxMetrics: 8 },
        mockResponses: false
      }
    ];
