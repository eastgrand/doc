  ...
  private loadEndpointConfigurations(): void {
    ...
    const configs: EndpointConfiguration[] = [
      ...
      },
      {
        ...
        targetVariable: 'cluster_assignment',
        scoreFieldName: 'cluster_assignment',
        requiredFields: ['target_variable'],
      ...
      },
      {
        ...
        keywords: ['demographic', 'population', 'age', 'income', 'lifestyle'],
      ...
      },
      {
        ...
        keywords: ['segment', 'segmentation', 'profile', 'persona', 'group', 'category', 'type'],
      ...
      },
      {
        ...
        keywords: ['scenario', 'what-if', 'simulation', 'alternative', 'impact', 'sensitivity', 'strategic', 'strategy', 'expansion', 'invest', 'investment', 'growth', 'opportunity', 'markets', 'top markets', 'best markets', 'strategic markets'],
