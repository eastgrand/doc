...
export const analysisTypeInstructions = {
  ...
  difference: 'Analyze the difference between two brands or variables in the provided data. Focus on performance gaps, competitive positioning, and areas where one significantly outperforms the other. When analyzing brand comparisons (like Nike vs Adidas), interpret percentage values as market share and explain competitive dynamics, geographic preferences, and strategic implications of the differences.',
