...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    comparative_analysis: 'Conduct product-focused brand comparison analysis between Nike and external competitors (Adidas, Puma, Under Armour). Focus on product performance differences, user preference variations, and feature optimization opportunities that give Nike competitive advantages versus independent athletic brands in specific markets.',
