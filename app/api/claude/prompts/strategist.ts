...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    comparative_analysis: 'Conduct strategic brand comparison analysis between Nike and external competitors (Adidas, Puma, Under Armour, New Balance, ASICS). Focus on competitive positioning, market share dynamics, and strategic opportunities for Nike to gain market advantage versus independent athletic brands. Identify geographic markets where Nike has competitive advantages or vulnerabilities versus these external competitors.',
