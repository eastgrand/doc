...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    comparative_analysis: 'Conduct strategic brand comparison analysis between Nike and key competitors (Adidas, Jordan). Focus on competitive positioning, market share dynamics, and strategic opportunities for Nike to gain market advantage. Identify geographic markets where Nike has competitive advantages or vulnerabilities versus competitors.',
