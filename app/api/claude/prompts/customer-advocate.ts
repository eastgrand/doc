...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    competitive_analysis: 'Analyze competitive positioning for customer experience improvements. Focus on service quality gaps, customer satisfaction opportunities, and ways Nike can deliver superior customer experiences versus competitors.',
    comparative_analysis: 'Conduct customer-focused brand comparison analysis between Nike and external competitors (Adidas, Puma, Under Armour). Focus on customer satisfaction differences, service quality variations, and customer loyalty opportunities that Nike can leverage to build stronger relationships than independent athletic brands.',
