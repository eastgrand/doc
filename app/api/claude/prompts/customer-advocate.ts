...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    comparative_analysis: 'Conduct customer-focused brand comparison analysis between Nike and competitors. Focus on customer satisfaction differences, service quality variations, and customer loyalty opportunities that Nike can leverage to build stronger relationships than Adidas and Jordan.',
