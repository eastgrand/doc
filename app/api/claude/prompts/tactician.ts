...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    comparative_analysis: 'Conduct tactical brand comparison analysis between Nike and competitors. Focus on operational deployment strategies, resource allocation optimizations, and immediate tactical advantages Nike can leverage against Adidas and Jordan in specific markets.',
