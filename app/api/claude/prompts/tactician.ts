...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    comparative_analysis: 'Conduct tactical brand comparison analysis between Nike and external competitors (Adidas, Puma, Under Armour). Focus on operational deployment strategies, resource allocation optimizations, and immediate tactical advantages Nike can leverage against independent athletic brands in specific markets.',
