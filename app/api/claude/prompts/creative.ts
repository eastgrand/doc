...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    comparative_analysis: 'Conduct creative brand comparison analysis between Nike and competitors. Focus on innovative differentiation strategies, creative positioning opportunities, and unexpected ways Nike can leverage competitive differences through breakthrough campaigns and unique market approaches.',
