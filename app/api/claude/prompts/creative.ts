...
${responseStyle}`,
  ...
  taskInstructions: {
    ...
    competitive_analysis: 'Analyze competitive positioning for creative differentiation opportunities. Focus on innovative ways Nike can stand out from competitors and creative strategies to capture market attention in unique ways.',
    comparative_analysis: 'Conduct creative brand comparison analysis between Nike and external competitors (Adidas, Puma, Under Armour). Focus on innovative differentiation strategies, creative positioning opportunities, and unexpected ways Nike can leverage competitive differences versus independent athletic brands through breakthrough campaigns and unique market approaches.',
